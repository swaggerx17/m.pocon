  ...
  return (
    ...
    <section className="page-section portfolio" id="portfolio">
            <div className="container">
                ...
                <h2 className="page-section-heading text-center text-uppercase text-secondary mb-0">Education Background</h2>
                {/* <!-- Icon Divider--> */}
                        ...
                        <div className="container">
                            <div className="row justify-content-center">
                                <div className="col-lg-8">
                                    ...
                                    <h2 className="portfolio-modal-title text-secondary text-uppercase mb-0">Junior High School</h2>
                                    {/* <!-- Icon Divider--> */}
                                    <div className="divider-custom">
                                        <div className="divider-custom-line"></div>
                                        <div className="divider-custom-icon"><i className="fas fa-star"></i></div>
                    ...
                    <div className="modal-body text-center pb-5">
                        <div className="container">
                            <div className="row justify-content-center">
                                <div className="col-lg-8">
                                    {/* <!-- Portfolio Modal - Title--> */}
                                    <h2 className="portfolio-modal-title text-secondary text-uppercase mb-0">Senior High School</h2>
                                    {/* <!-- Icon Divider--> */}
                                    <div className="divider-custom">
                                        <div className="divider-custom-line"></div>
                                        <div className="divider-custom-icon"><i className="fas fa-star"></i></div>
                                    ...
                                    {/* <!-- Portfolio Modal - Text--> */}
                                    <p className="mb-4">In senior high, I chose the Technical-Vocational-Livelihood Computer Systems Servicing (CSS). This program allowed me to explore a variety of subjects, including humanities, track is a transformative experience, equipping students with essential skills in computer hardware troubleshooting, software installation, and network servicing, all while preparing them for future careers or entrepreneurial opportunities in the ever-evolving field of technology..</p>
                                    <button className="btn btn-primary" data-bs-dismiss="modal">
                                        <i className="fas fa-xmark fa-fw"></i>
                                        Close Window
                                    </button>
                    ...
                    <div className="modal-body text-center pb-5">
                        <div className="container">
                            <div className="row justify-content-center">
                                <div className="col-lg-8">
                                    {/* <!-- Portfolio Modal - Title--> */}
                                    <h2 className="portfolio-modal-title text-secondary text-uppercase mb-0">College</h2>
                                    {/* <!-- Icon Divider--> */}
                                    <div className="divider-custom">
                                        <div className="divider-custom-line"></div>
                                        <div className="divider-custom-icon"><i className="fas fa-star"></i></div>
